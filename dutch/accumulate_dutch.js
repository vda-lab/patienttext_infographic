    ...
    function readFile(file) {
        ...
        d3.xml(file).then(xml => {
            ...
            */
            ...
            letterText = letterText.split("-----")[1];

            letterText = letterText.replace(/\s\./g, ".");
            letterText = letterText.replace(/\s\,/g, ",");

            letterText = letterText.replace("Probleemstelling:", "<h2>Probleemstelling:</h2>");
            letterText = letterText.replace("PREOPERATIEF", "<h2>PREOPERATIEF</h2>");
            letterText = letterText.replace("POSTOPERATIEF", "<h2>POSTOPERATIEF</h2>");
            letterText = letterText.replace("Huidige opname:", "<h2>Huidige opname:</h2>");
            letterText = letterText.replace("Verdere zorgen:", "<h2>Verdere zorgen:</h2>");
